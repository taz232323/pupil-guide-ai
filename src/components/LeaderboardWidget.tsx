    ...
    <Card className="border-0 shadow-card">
      ...
      <CardContent className="space-y-2">
        ...
        {myRank !== null && myRank > 3 && (
          <div className="mt-1 rounded-lg border border-primary bg-primary/10 px-3 py-2 flex items-center gap-3">
            <span className="w-6 text-center text-sm font-bold text-primary">#{myRank}</span>
            <span className="flex-1 text-sm font-medium">You</span>
            <span className="inline-flex items-center gap-1 text-sm font-semibold">
              <Star className="h-3.5 w-3.5 fill-amber-400 text-amber-500" />{myCoins}
            </span>
          </div>
        )}
      </CardContent>
